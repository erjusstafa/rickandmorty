...
import { IContainer, IResults } from "../../interface/interface";
import { useReduxSelector } from "../../redux/hooks";
import Pagination from "../Pagination";
import styles from "./style.module.scss";

const Container = ({ dataApi, valSearch, goToDetails }: IContainer) => {
  ...
  const { loading } = useReduxSelector((state) => state.home);
